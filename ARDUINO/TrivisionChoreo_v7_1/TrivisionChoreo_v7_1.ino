/*
 * TrivisionChoreo v7.1
 *
 * Motor 7 test — 2 RPM, MICRO_MULT 1
...
#define RAMP_START_TK 500U
#define CRUISE_TK 188U
...
void setup() {
  ...
  Serial.println(F("=== TrivisionChoreo v7.1 — MOTOR 7 TEST ==="));
  Serial.println(F("2 RPM, MICRO_MULT 1, 1067 steps per 120°"));
  Serial.println();
