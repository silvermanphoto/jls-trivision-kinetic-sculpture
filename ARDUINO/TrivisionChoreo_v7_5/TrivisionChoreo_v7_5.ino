/*
 * TrivisionChoreo v7.5
 *
 * Sequential Cascade — M1 through M12, one at a time
 * 0.75 RPM CCW, S-curve ramps, seamless loop forever.
...
void setup() {
  ...
  Serial.println(F("=== TrivisionChoreo v7.5 — SEQUENTIAL CASCADE ==="));
  Serial.println(F("0.75 RPM CCW, M1→M12, seamless loop"));
  Serial.println();
