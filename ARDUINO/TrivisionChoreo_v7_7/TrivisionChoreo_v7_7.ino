/*
 * TrivisionChoreo v7.7
 *
 * Sequential Cascade — M1 through M12, one at a time
 * 1.0 RPM CCW, S-curve ramps, seamless loop forever.
...
// === SPEED: 1.0 RPM ===
//   0.5 RPM = 750 ticks → 1.0 RPM = 375 ticks
...
void setup() {
  ...
  Serial.println(F("=== TrivisionChoreo v7.7 — SEQUENTIAL CASCADE ==="));
  Serial.println(F("1.0 RPM CCW, M1→M12, seamless loop"));
  Serial.println();
