/*
 * TrivisionChoreo v7.4
 *
 * Motor 7 test — 0.75 RPM, MICRO_MULT 1
...
// === SPEED: 0.75 RPM ===
//   0.5 RPM = 750 ticks → 0.75 RPM = 500 ticks
...
void setup() {
  ...
  Serial.println(F("=== TrivisionChoreo v7.4 — MOTOR 7 TEST ==="));
  Serial.println(F("0.75 RPM, MICRO_MULT 1, 1067 steps per 120°"));
  Serial.println();
