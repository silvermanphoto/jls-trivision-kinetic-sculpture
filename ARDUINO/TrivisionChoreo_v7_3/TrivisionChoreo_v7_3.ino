/*
 * TrivisionChoreo v7.3
 *
 * Motor 7 test — 1.5 RPM, MICRO_MULT 1
 * CCW 120°, pause 5s, CW 120°, stop.
 *
 * NOTE: If stutter persists, the real fix is setting TMC2209
 * MS pins for 1/32 microstepping (MS1=HIGH, MS2=LOW),
 * then using MICRO_MULT 4 in code.
 */
...
#define MICRO_MULT 1
#define STEPS_120 (1067L * MICRO_MULT)   // 1067 steps

// === SPEED: 1.5 RPM ===
//   0.5 RPM = 750 ticks → 1.5 RPM = 250 ticks
#define RAMP_STEPS 200L
#define RAMP_START_TK 667U
#define CRUISE_TK 250U
...
void setup() {
  ...
  Serial.println(F("=== TrivisionChoreo v7.3 — MOTOR 7 TEST ==="));
  Serial.println(F("1.5 RPM, MICRO_MULT 1, 1067 steps per 120°"));
  Serial.println();
