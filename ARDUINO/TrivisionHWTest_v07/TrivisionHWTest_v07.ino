/*
 * TrivisionHWTest v07 — POST-REWIRE SMOKE TEST AND MOTOR IDENTIFICATION
 * ============================================================
 * Date: 2026-09-25 (forked from v06, 2026-07-29)
 *
...
void setup() {
  ...
  Serial.println();
  Serial.println(F("============================================================"));
  Serial.println(F("  TrivisionHWTest v07 — SMOKE TEST AND MOTOR IDENTIFICATION"));
